<div id="<?php echo $id; ?>">
	...
	foreach($images as $image): ?>
		<li<?php if($i%$imagesPerRow==1) echo ' style="clear:left"'; ?>><a href="<?php echo $image['url']; ?>"><img src="<?php echo $image['thumb']; ?>" alt="<?php echo $image['alt']; ?>" /><?php echo $image['alt']; ?></a></li>
	<?php
		$i++;
	endforeach; ?>
	</ul>
