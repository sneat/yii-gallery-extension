<div id="<?php echo $id; ?>">
	...
	foreach($images as $image): ?>
		<li<?php if($i%$imagesPerRow==1) echo ' class="newRow"'; ?>><a href="<?php echo $image['url']; ?>" title="<?php echo $image['alt']; ?>"><img src="<?php echo $image['thumb']; ?>" alt="<?php echo $image['alt']; ?>" /><?php echo $image['alt']; ?></a></li>
	<?php
		$i++;
	endforeach; ?>
	</ul>
	<div class="newRow"></div>
	<?php $this->widget('CLinkPager',array('pages'=>$pages,'cssFile'=>'/css/pager.css')); ?>
